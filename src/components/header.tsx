            ...
            <div className={"header__inner"}>
                ...
                <div className={"link-holder"}>
                    <a
                        ...
                        className={`link-holder__link ${scrollPosition > 80 ? "link-holder__link--dark" : ""}`}
                    >
                        <svg id="icon-discord" className="link-holder__link--icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
